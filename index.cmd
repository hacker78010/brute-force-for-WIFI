...
title Batch Wi-Fi Brute Forcer by ektor
color 0f
...
:program_prompt
    ...
    call :color_echo . white "$ "
	call :color_echo . blue "%computername%"
	call :color_echo . violet ">>"
...
:help
	...
	echo.
	echo  More projects from hacker78010:
	echo  https://github.com/hacker78010
	echo.
	echo.
